package com.mexc.security.quartz;
 ...
 * Class Describe
 * <p>
 * User: yangguang Date: 17/8/2 Time: 下午4:04
 */
    ...
    public void enableSessionValidation() {
        ...
        try {
            SimpleTrigger trigger = TriggerBuilder.newTrigger().startNow()
                    .withIdentity(JOB_NAME, Scheduler.DEFAULT_GROUP).withSchedule(SimpleScheduleBuilder.simpleSchedule()
