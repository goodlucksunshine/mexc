...
public class Test {
    ...
    public static BigDecimal significand(BigDecimal oldDouble, int scale) {
        ...
        //此处的scale表示的是，几位有效位数
        BigDecimal b = new BigDecimal(oldDouble.toPlainString(),new MathContext(scale,rMode));
        return b;
    }
    ...
    public static void main(String[] args) {
        BigDecimal d = new BigDecimal("0.000011100001").stripTrailingZeros();
        int scale = 8;
        BigDecimal d1 = significand(d,MathContext.DECIMAL32.getPrecision());
