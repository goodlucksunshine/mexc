...
<blockquote class="layui-elem-quote news_search">
    <div class="layui-inline">
        <form id="searchForm" name="searchForm" class="layui-form" action="vcoin/list">
            ...
            <div class="layui-input-inline">
                <input type="text" value="${searchKey}" name="searchKey" placeholder="请输入币种"
    ...
    <div class="layui-inline">
        <%--<shiro:hasPermission name="vcoin:add">--%>
        <a class="layui-btn layui-btn-normal doAdd_btn">添加币种</a>
        <%--</shiro:hasPermission>--%>
    </div>
    <div class="layui-inline">
    ...
    <table class="layui-table">
        ...
        <c:forEach var="item" items="${page.resultList}">
            <tr>
                ...
                <td><img height="30" width="30" src="file/download/${item.icon}"></td>
                <td>${item.vcoinNameFull}</td>
                <td>${item.vcoinToken}</td>
                <td>
                    <c:choose>
                ...
                <td>
                    <a class="layui-btn layui-btn-mini balance" data-id="${item.id}">
                        <i class="iconfont icon-edit"></i> 余额检查
                    </a>
