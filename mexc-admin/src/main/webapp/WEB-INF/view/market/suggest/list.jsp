...
<blockquote class="layui-elem-quote news_search">
    <div class="layui-inline">
        <form id="searchForm" name="searchForm" class="layui-form" action="market/suggest/list">
    ...
    <div class="layui-inline">
        <%--<shiro:hasPermission name="role:add">--%>
            <a class="layui-btn layui-btn-normal doAdd_btn">添加推荐</a>
        <%--</shiro:hasPermission>--%>
    </div>
    <div class="layui-inline">
            ...
            <c:forEach var="item" items="${page.resultList}">
                <tr>
                    ...
                    <td>
                        ...
                        <a class="layui-btn layui-btn-danger layui-btn-mini do_del" data-marketId="${item.marketId}" data-vcoinId="${item.vcoinId}">
...
<script>
    layui.config({
        ...
        $("body").on("click",".do_del",function(){
            var _this = $(this);
            var marketId = _this.attr("data-marketId");
            var vcoinId = _this.attr("data-vcoinId");
            layer.confirm('确定取消推荐？',{icon:3, title:'提示信息'},function(index){
                $.ajax({
                    url: "market/suggest/del.do?marketId="+marketId+"&vcoinId="+vcoinId,
                    type: 'POST',
                    dataType: "json",
