...
<form id="data-form" class="layui-form" style="width:80%;padding-top: 20px;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="vcoinId" lay-filter="vcoinId" lay-verify="required">
                <option value=""></option>
                <c:forEach var="item" items="${vCoinList}">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="checkbox" name="suggest" lay-skin="switch" value="0" lay-filter="suggest" lay-text="是|否">
        </div>
    </div>
...
<script type="text/javascript">
    ...
    layui.config({
        ...
        form.on('submit(submitData)',function(data){
            $.ajax({
                url: "market/vcoinmanage/save.do",
                type: 'POST',
                dataType: "json",
                data: data.field,
                success: function (r) {
