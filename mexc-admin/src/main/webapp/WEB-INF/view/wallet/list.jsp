...
<blockquote class="layui-elem-quote news_search">
    ...
    <div class="layui-inline">
        <%--<shiro:hasPermission name="role:add">--%>
            <a class="layui-btn layui-btn-normal doAdd_btn">添加钱包</a>
            <a class="layui-btn layui-btn-normal reload_btn">加载钱包</a>
        <%--</shiro:hasPermission>--%>
    </div>
    <div class="layui-inline">
        ...
        <tbody class="data_content">
            <c:forEach var="item" items="${page.resultList}">
                <tr>
                    ...
                    <td>${item.type}</td>
                    <td><c:if test="${item.status==1}"><span class="layui-bg-green">在线</span></c:if><c:if test="${item.status==-1}"><span class="layui-bg-red">离线</span></c:if> </td>
                    <td>${item.balance}</td>
                    <td>
