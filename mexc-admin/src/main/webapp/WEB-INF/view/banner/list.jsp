...
<blockquote class="layui-elem-quote news_search">
    <div class="layui-inline">
        <form id="searchForm" name="searchForm" class="layui-form" action="banner/list">
    ...
    <div class="layui-inline">
        <%--<shiro:hasPermission name="role:add">--%>
            <a class="layui-btn layui-btn-normal doAdd_btn">添加banner</a>
        <%--</shiro:hasPermission>--%>
    </div>
    <div class="layui-inline">
