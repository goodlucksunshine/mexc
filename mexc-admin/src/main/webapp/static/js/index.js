...
layui.config({
	...
	var form = layui.form,
		...
		tab = layui.bodyTab({
			...
			url : "resource/menuTree" //获取菜单json地址
		});
	...
	function lockPage(){
		layer.open({
			...
			content : '	<div class="admin-header-lock" id="lock-box">'+
							'<div class="admin-header-lock-img"><img src="'+headPic+'"/></div>'+
							'<div class="admin-header-lock-name" id="lockUserName">'+adminName+'</div>'+
							'<div class="input_btn">'+
	...
	$("body").on("click","#unlock",function(){
		if($(this).siblings(".admin-header-lock-input").val() == ''){
            ...
            //这里可以使用ajax方法解锁
            $.post('admin/unlock.do',{password:pwd},function(data){
                //验证成功
                if(data.code == 0){
                    //关闭锁屏层
